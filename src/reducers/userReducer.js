import { editAddressHandler, makeAddressPrimayHandler } from "../utils/AddressHelper";
...
const userReducer=(state,action)=>{
    switch(action.type){
        ...
        case 'EDIT_ADDRESS':
                return {...state,user:{...state.user,addresses:editAddressHandler(state.user.addresses,action.payload)}}    
        case 'DELETE_ADDRESS':
        ...
        case 'MAKE_ADDRESS_PRIMARY':
            return {...state,user:{...state.user,addresses:makeAddressPrimayHandler(state.user.addresses,action.payload)}}    
        ...
        case 'REMOVE_FROM_WISHLIST':
            return {...state,user:{...state.user,wishlist:state.user.wishlist.filter(prodId=>prodId.toString()!==action.payload.toString())}}    
        default : 
            return {...state}
